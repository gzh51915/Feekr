...
class NavSearch extends Component {
    ...
    async componentDidMount() {
        ...
        wite.forEach(item => {
            if (item.id === parseInt(this.state.style)) {
                this.setState({
                    dataname: item.name
                })
            }
                    ...
                    <section>
                        <section>
                            <ul className="search-result-product">
                                {
                                    num4.map(item => {
                                        return <li key={item.productId} onClick={this.changeMenu.bind(this, `xiangqing/${item.productId}`)}>
                                            <div className="main">
                                                <img src={item.productCover} className=" lazyloaded" alt="" />
